...
{
    /**
     * Default model used for API-based token counting when none is passed to the
     * constructor. Must be a currently available model ID — retired IDs cause the
     * count_tokens endpoint to return 404.
     */
